...
ACTION_POINTS = {
    ...
    "map_coord_y_input": (1393 / 2048, 1034 / 1152),
...
MAP_KEYPAD_POINTS = {
    "vertical": {
        "1": (839 / 2048, 608 / 1152),
        "2": (968 / 2048, 609 / 1152),
        "3": (1098 / 2048, 609 / 1152),
        "4": (839 / 2048, 736 / 1152),
        "5": (969 / 2048, 736 / 1152),
        "6": (1099 / 2048, 736 / 1152),
        "7": (840 / 2048, 863 / 1152),
        "8": (968 / 2048, 863 / 1152),
        "9": (1098 / 2048, 863 / 1152),
        "0": (1227 / 2048, 736 / 1152),
        "delete": (1227 / 2048, 609 / 1152),
        "confirm": (1227 / 2048, 863 / 1152),
    },
    "horizontal": {
        "1": (839 / 2048, 608 / 1152),
        "2": (968 / 2048, 609 / 1152),
...
def run_resolve_gift_chat_threshold(hwnd: int, action: dict[str, Any]) -> dict[str, Any]:
    ...
    if gift_policy == "gift_two":
        ...
        if current_stage_state["stage"] != "gift_screen":
            raise RuntimeError(
                "Gift slot selection left gift_screen unexpectedly while resolving threshold. "
