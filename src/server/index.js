...
const FIXED_SCRIPT_STAGE_VOICES = {
  sell_loop: [
    {
      thinkingChain: [
        "赚钱本来就该先做买卖，我先按最普通的路子试试。",
        "货得先进，摊子得先摆起来，不然连账都没法算。",
        "街上能正经挣的钱，先挣到手再说。"
      ],
      decide: "我先去买货，再把摊子顶起来试三轮。",
      persona: "先按老实财路做一遍。",
      progress: {
        stock: "先把手里这点货补齐，空着手站街上也不像在做生意。",
        hawk: "货已经拿到手了，我先把摊子支起来，看看今天这条买卖路到底顺不顺。"
      },
      resultFactory: ({ recovered }) => recovered
        ? "刚才手上卡了一下，不过货还是让我补上了，摊子也照样重新支起来了。"
        : "货我已经补上了，摊子也支起来了，这条正经买卖路还算能走。"
    },
    {
      thinkingChain: [
        "做生意是慢了点，可慢归慢，总得先看看能不能做下去。",
        "街上这么多人来来往往，总不至于一笔都做不成。",
        "我先把摊子再撑一会儿，看看到底是货不行，还是路子不对。"
      ],
      decide: "我再去补一趟货，把这摊普通生意继续撑下去看看。",
      persona: "先老老实实算账，别急着怀疑别的门路。",
      progress: {
        stock: "先去把货再补齐，摊子想撑下去，总不能先让货架空着。",
        hawk: "行，货到位了，我把摊子一摆，再看看今天到底能不能顺出去几笔。"
      },
      resultFactory: ({ recovered }) => recovered
        ? "刚才差点把这笔生意断掉，好在我又把摊子顺回来了。"
        : "这笔街面生意总算又续上了，钱不算多，至少还像门正经买卖。"
    },
    {
      thinkingChain: [
        "摆摊这条路我已经走了几轮，差不多也该看出它到底有多慢了。",
        "真要靠这么一点点卖，钱不是挣不到，就是太磨人。",
        "我先把这轮买卖做完，再考虑要不要换个更快的找钱办法。"
      ],
      decide: "我先把这轮买卖跑完，再看看是不是得换别的挣钱路子。",
      persona: "先把普通买卖做到底，再判断是不是该换思路。",
      progress: {
        stock: "再去补最后一波货，把这条摆摊路子彻底试明白再说。",
        hawk: "货已经抱回来了，我把摊子一撑，看看这口正经钱到底还能不能再顺一点。"
      },
      resultFactory: ({ recovered }) => recovered
        ? "刚才那一下差点把摊子弄乱，好在我又给它扶正了。"
        : "这一波货也顺出去了，只是这么卖下去，实在有点太慢了。"
    }
  ],
  social_warm: [
    {
      thinkingChain: [
        "摆摊这条路太磨人了，我去找人打听打听别的门路。",
        "礼数先给到，话先聊开，总比一个人闷头卖货快。",
        "只要他们肯多说两句，说不定就能问出更省劲的办法。"
      ],
      decide: "我先拿礼数开门，再顺着话头问问有没有更快的路子。",
      persona: "先当个会来事的普通人，把门路慢慢问出来。",
      progress: {
        trade: "先借交易把门推开，做生意的人总得先把场面搭上。",
        gift: "礼都拿到手了，我先把面子给足，省得话还没问就先冷场。",
        talk: "行，门算是开了，我现在顺着他的话往下问，看能不能问出点门路。",
        recover: "刚才那个人嘴太滑，我换个更愿意接话的继续打听，不在他身上白耗。",
        replyLoop: [
          "他既然还肯接话，我就再顺着问一句，看看能不能摸到点门路。",
          "这人绕得是真有耐心，我再陪他兜一圈，看他能不能说点实在的。",
          "话都聊到这儿了，我再往前问一句，看看他到底知道多少。",
          "他还在跟我打太极，那我就再顺手追一句。"
        ]
      },
      resultFactory: ({ replyRounds, recovered, recoveryKind }) => {
        if (recoveryKind === "npc_reply_loop") {
          ...
          return `刚才话头差点断掉，我又顺着问了${replyRounds}轮，可他还是净拿空话打转。`;
        }
        if (recovered) {
          return "刚才那个人不怎么肯接话，我换了个目标又把话头续上了。";
        }
        if (replyRounds > 0) {
          return `礼物我都送了，还陪他聊了${replyRounds}轮，可他还是没说多少实在话。`;
        }
        return "礼我送了，场面也陪圆了，可真问到门路时，他还是绕来绕去。";
      }
    },
    {
      thinkingChain: [
        "光靠摆摊挣钱还是太慢，我再换个人打听一轮。",
        "礼也送了，话也聊了，总该有人肯说点有用的吧。",
        "我再顺着他们的口风磨一轮，看看能不能问出更快的路子。"
      ],
      decide: "我换个话头，再从他们嘴里问点更实在的门路出来。",
      persona: "继续客客气气地打听，但已经不想再白聊了。",
      progress: {
        trade: "先把场面重新铺平，省得一会儿问起路子来又显得生分。",
        gift: "礼数我都补上了，总得有人愿意认真跟我聊两句吧。",
        talk: "行，我继续顺着他说，但这回得把话往实处带。",
        recover: "这人太会打滑，我换个更愿意说话的，不在他身上白耗。",
        replyLoop: [
          "他还在绕，我再陪一句，先别让这条话路断掉。",
          "嘴上这么会躲，我倒想看看他能绕到第几句。",
          "行，那我再往里探一句，看他这回能不能说点实在的。",
          "话都聊成这样了，我不信他还能一点门路都不漏。"
        ]
      },
      resultFactory: ({ replyRounds, recovered, recoveryKind }) => {
        if (recoveryKind === "npc_reply_loop") {
        ...
        if (replyRounds > 0) {
          return `面子我给足了，话也陪他绕了${replyRounds}轮，他还是比我还能打哈哈。`;
        }
        return "礼数已经做到位了，可一问到更快的路子，他那张嘴还是抿得很紧。";
      }
    }
  ],
  social_dark: [
    {
      thinkingChain: [
        "礼我都送了，话我也陪够了，他们还在拿空话糊弄我。",
        "再这么绕下去就是拿我当傻子，那我就不打算继续客气了。",
        "既然好好问不出真话，我就给他们一点翻脸前的味道。"
      ],
      decide: "我继续装熟，但这回再不说真话，我就真要翻脸了。",
      persona: "客气已经快用完了，接下来得让他们听出点不对劲。",
      progress: {
        trade: "先把门照样推开，脸上还得挂着笑，火气先压在话里。",
        gift: "礼我照送，但接下来他要还拿空话堵我，就别怪我口气变了。",
        talk: "行，门开了，我这回一边陪聊，一边提醒他别再跟我绕。",
        recover: "这人嘴太油，我换个更经不起压的继续问，不让他在我眼前滑过去。",
        replyLoop: [
      ...
      resultFactory: ({ replyRounds, recovered, recoveryKind }) => {
        ...
        return "礼数我给了，提醒我也递过去了，可他还是缩着不肯说真话。";
      }
    },
    {
      thinkingChain: [
        "笑脸我已经陪够了，再软下去就是白白被他们牵着走。",
        "礼数照旧，但这回话得更重一点，不然他们真当我好敷衍。",
        "他只要听出我快翻脸了，嘴里的真话就更容易掉出来。"
      ],
      decide: "我继续陪他说，但每一句都得让他知道我已经快没耐心了。",
      persona: "表面还在讲礼数，语气已经开始发硬了。",
      progress: {
        trade: "先把场面撑住，别还没开口就把桌子先掀了。",
        gift: "礼数还是要做，可我今天不是来陪他舒舒服服收礼的。",
        talk: "行，我继续陪笑，但这回每一句都得让他听出我快翻脸了。",
        recover: "这人太会打滑，我换个没那么经压的再继续问。",
        replyLoop: [
          "他还在兜圈子，那我就再顺着他的话往里塞一句警告。",
          "我再接一句，让他嘴上继续笑，心里先发虚。",
